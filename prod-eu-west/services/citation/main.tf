...
resource "aws_cloudwatch_metric_alarm" "citation_cpu_scale_up" {
  alarm_name          = "citation_cpu_scale_up"
...
resource "aws_cloudwatch_metric_alarm" "citation_cpu_scale_down" {
  alarm_name          = "citation_cpu_scale_down"
