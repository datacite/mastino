...
resource "aws_route53_record" "txt-datacite" {
  ...
  records = [
    ...
    "v=spf1 include:_spf.google.com include:_spf.salesforce.com include:_spf.intacct.com ~all",
    var.ms_record,
    var.verification_record,
    "intacct-esk=2C496A32C127CCC5E0638D86450A7D6F"
  ]
}
...
resource "aws_route53_record" "sage-spf" {
  zone_id = aws_route53_zone.production.zone_id
  name    = "2mdymxgrf9kf82r1o2kye5u27.datacite.org"
  type    = "CNAME"
  ttl     = "300"
  records = ["u33115566.eoh.2mdymxgrf9kf82r1o2kye5u27.securemail-intacct.com"]
}
resource "aws_route53_record" "sage-dkim" {
  zone_id = aws_route53_zone.production.zone_id
  name    = "1bs._domainkey.datacite.org"
  type    = "CNAME"
  ttl     = "300"
  records = ["1bs.domainkey.u33115566.eoh.2mdymxgrf9kf82r1o2kye5u27.securemail-intacct.com"]
}

resource "aws_route53_record" "sage-dkim2" {
  zone_id = aws_route53_zone.production.zone_id
  name    = "1bs2._domainkey.datacite.org"
  type    = "CNAME"
  ttl     = "300"
  records = ["1bs2.domainkey.u33115566.eoh.2mdymxgrf9kf82r1o2kye5u27.securemail-intacct.com"]
}

resource "aws_route53_record" "sage-vertify" {
  zone_id = aws_route53_zone.production.zone_id
  name    = "intacct-mail-verify.datacite.org"
  type    = "TXT"
  ttl     = "300"
